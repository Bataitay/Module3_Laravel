...
.nav-item a{
    ...
    <div class="m-header">
        ...
        <a href="#!" class="b-brand">
            ...
            <img src="{{ asset( 'assets/images/apple.jfif')}}" width="90px" class="logo">
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                ...
                <div class="search-bar">
                    <input id="myInput" type="text" class="form-control border-0 shadow-none" placeholder="Search hear">
